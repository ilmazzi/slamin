    ...
    <div class="container-fluid h-100">
        <div class="row h-100">
            ...
            <div class="col-lg-7 left-section">
                <div>
                    <div class="logo mb-3">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="{{ __('app.slam_in_logo') }}" class="img-fluid" style="max-width: 250px;">
                    </div>
                ...
                <div class="form-container">
                    <div class="text-center mb-4">
                        <div class="d-lg-none mb-3">
                            <img src="{{ asset('assets/images/logo.png') }}" alt="{{ __('app.slam_in_logo') }}" class="img-fluid" style="max-width: 180px;">
                        </div>
