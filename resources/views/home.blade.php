                    ...
                    <div class="card equal-card">
                        <div class="card-header">
                            ...
                            <div class="events-slider app-arrow" id="videos-slider">
                                @foreach ($recentVideos->take(10) as $video)
                                        <div class="autoplay-item">
                                            <div class="card overflow-hidden hover-effect h-100">
                                ...
                                <div class="col-md-3 col-6 mb-3">
                                    <div class="card" style="cursor: default; pointer-events: none;">
                                        <div class="card-body text-center py-3">
                                            ...
                                            <h4 class="mb-1 text-success f-s-18">{{ number_format($stats['total_views']) }}</h4>
                                ...
                                <div class="col-md-3 col-6 mb-3">
                                    <div class="card" style="cursor: default; pointer-events: none;">
                                        <div class="card-body text-center py-3">
                                            ...
                                            <h4 class="mb-1 text-warning f-s-18">{{ number_format($stats['total_events']) }}</h4>
