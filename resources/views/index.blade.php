...
@section('title', 'Ecommerce {{ __('dashboard.dashboard') }}')
@section('css')
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6 cart-side-card mt-3 mt-sm-0">
                                ...
                                <p class="f-w-500 mb-0 txt-ellipsis-1">  Support: <a href="{{route('email')}}" class="link-primary text-d-underline ">https://support.aicom.com/order?r72qU2892</a> </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xxl-3">
                <div class="card offer-card-box">
                    ...
                    <div class="card-body offer-card-body overflow-hidden ">
                        ...
                        <div>
                            <a href="{{route('product')}}" target="_blank" class="btn btn-white  f-w-500 w-100 my-2">Shop Now</a>
            ...
            <div class="col-sm-6 col-md-4 col-xxl-2 order-3-md">
                <div class="card service-trial-card">
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <a href="{{route('chat')}}" target="_blank" class="btn btn-primary btn-sm w-100 text-nowrap">Start Free Trial</a>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content welcome-card">
                ...
                <div class="modal-body p-0">
                    <div>
                        <img src="{{asset('../assets/images/modals/welcome-bg.png')}}" alt="img" class=" img-fluid" >
                        <div>
                            <img src="{{asset('../assets/images/modals/welcome-rocket.png')}}" alt="img" class="modal-rocket img-fluid">
                        </div>
                    </div>
