        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body text-center py-5">
                    <div class="mb-4">
                        <i class="ph ph-exclamation-triangle f-s-48 text-warning mb-3"></i>
                        <h1 class="display-4 text-warning fw-bold">400</h1>
                        <h2 class="h3 text-dark mb-3">Richiesta Non Valida</h2>
