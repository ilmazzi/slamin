...
@section('title', 'Modifica Posizione Ingaggio')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Modifica Posizione di Ingaggio</h4>

                        <form action="{{ route('admin.gig-positions.update', $position) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('key') is-invalid @enderror"
                                           id="key" name="key" value="{{ old('key', $position->key) }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                              ...
                                              placeholder="Descrivi brevemente questa posizione...">{{ old('description', $position->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror"
                                           id="sort_order" name="sort_order" value="{{ old('sort_order', $position->sort_order) }}"
                                           min="0" step="1">
                                    @error('sort_order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-12">
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="ph ph-check me-2"></i>Aggiorna Posizione
                                        </button>
                                    </div>
                                </div>
                            </div>
