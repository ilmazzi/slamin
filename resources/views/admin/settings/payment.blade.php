...
@section('title', 'Impostazioni Pagamenti - Admin')
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
                <form id="paymentSettingsForm" method="POST" action="{{ route('admin.settings.payment.update') }}">
                @csrf
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="number"
                                       ...
                                       value="{{ $paymentSettings['translation_commission_percentage'] ?? '0.10' }}"
                                       step="0.01"
                                       min="0"
                                       max="1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number"
                                       ...
                                       value="{{ $paymentSettings['translation_commission_fixed'] ?? '0.00' }}"
                                       step="0.01"
                                       min="0">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    <input class="form-check-input"
                                           ...
                                           value="true"
                                           {{ ($paymentSettings['stripe_enabled'] ?? 'true') === 'true' ? 'checked' : '' }}>
                            ...
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    <input class="form-check-input"
                                           ...
                                           value="true"
                                           {{ ($paymentSettings['stripe_connect_enabled'] ?? 'false') === 'true' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="stripe_mode" name="settings[stripe_mode]">
                                    <option value="test" {{ ($paymentSettings['stripe_mode'] ?? 'test') === 'test' ? 'selected' : '' }}>
                                        Test (Sviluppo)
                                    </option>
                                    <option value="live" {{ ($paymentSettings['stripe_mode'] ?? 'test') === 'live' ? 'selected' : '' }}>
                                        Live (Produzione)
                                    </option>
                                </select>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    <input class="form-check-input"
                                           ...
                                           value="true"
                                           {{ ($paymentSettings['paypal_enabled'] ?? 'true') === 'true' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="paypal_mode" name="settings[paypal_mode]">
                                    <option value="sandbox" {{ ($paymentSettings['paypal_mode'] ?? 'sandbox') === 'sandbox' ? 'selected' : '' }}>
                                        Sandbox (Sviluppo)
                                    </option>
                                    <option value="live" {{ ($paymentSettings['paypal_mode'] ?? 'sandbox') === 'live' ? 'selected' : '' }}>
                                        Live (Produzione)
                                    </option>
                                </select>
                                <div class="form-text">Modalità di funzionamento</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.settings.payment.reset') }}"
