                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.moderation.settings.update') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="articles_auto_approve" name="articles_auto_approve" value="1" {{ ($formSettings['articles_auto_approve']['value'] ?? false) ? 'checked' : '' }}>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="d-flex flex-column gap-2">
                            ...
                            <div class="d-flex justify-content-between">
                                <span>Articoli:</span>
                                <span class="badge bg-{{ ($formSettings['articles_auto_approve']['value'] ?? false) ? 'success' : 'secondary' }}">
                                    {{ ($formSettings['articles_auto_approve']['value'] ?? false) ? 'Sì' : 'No' }}
                                </span>
                            </div>
                            <div class="d-flex justify-content-between">
                                <span>Caroselli:</span>
