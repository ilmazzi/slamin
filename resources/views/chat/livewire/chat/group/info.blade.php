                ...
                <section class="mx-auto items-center justify-center grid">
                    <div @dusk="edit_avatar_label" class="relative  h-32 w-32 overflow-clip mx-auto rounded-full">
                        ...
                        <label wire:target="photo" wire:loading.class="cursor-not-allowed" for="photo"
                            ...
                            <x-chat::avatar wire:loading.class="cursor-not-allowed" group="{{ $isGroup }}"
    ...
    <footer class="flex flex-col justify-start w-full">
                ...
                <x-chat::actions.open-chat-drawer component='chat.chat-group-permissions'
                    ...
                    <button
                        ...
                        <div class="flex gap-3 items-center ">
                            ...
                            <span>@lang('chat::chat.group.info.actions.group_permissions.label')</span>
                        </div>
                    </button>
        ...
        {{-- Exit Group --}}
            <button wire:confirm="{{ __('chat::chat.group.info.actions.exit_group.confirmation_message') }}" wire:click="exitConversation"
                ...
                <span>@lang('chat::chat.group.info.actions.exit_group.label')</span>
            </button>
        @endif
