                    ...
                    <div class="card-body pa-20">
                        @foreach(auth()->user()->eventInvitations()->where('status', 'pending')->with('event')->take(3)->get() as $invitation)
                            <div class="d-flex align-items-center mb-3 pb-2 border-bottom">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="d-flex gap-1">
                                        <form action="{{ route('event-invitations.accept', $invitation) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('PATCH')
                                        ...
                                        <form action="{{ route('event-invitations.decline', $invitation) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('PATCH')
