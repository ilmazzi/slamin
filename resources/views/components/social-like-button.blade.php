...
<div class="social-like-btn"
    ...
    <img src="{{ asset('assets/images/like.png') }}" alt="Like" style="{{ $iconStyle }} {{ $isLiked ? 'filter: brightness(0) saturate(100%) invert(27%) sepia(51%) saturate(2878%) hue-rotate(346deg) brightness(104%) contrast(97%);' : 'filter: brightness(0) saturate(100%) invert(60%) sepia(0%) saturate(0%) hue-rotate(0deg) brightness(89%) contrast(86%);' }}">
...
<div class="social-like-counter"
    ...
    <img src="{{ asset('assets/images/like.png') }}" alt="Like" style="{{ $iconStyle }} filter: brightness(0) saturate(100%) invert(60%) sepia(0%) saturate(0%) hue-rotate(0deg) brightness(89%) contrast(86%); opacity: 0.6;">
    <span class="text-secondary like-count {{ $textClass }}">{{ number_format($likeCount) }}</span>
</div>
@endif
