                    ...
                    <div class="mt-3">
                        <div class="alert alert-info">
                            ...
                            <ul class="list-unstyled mb-0 small">
                                ...
                                <li>• <strong>{{ __('permissions.roles') }} flessibili:</strong> {{ __('register.poet') }}, {{ __('events.organizer') }}, {{ __('register.venue_owner') }}, {{ __('register.audience') }}</li>
