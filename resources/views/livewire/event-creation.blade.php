        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-3">
                <div class="card-body text-center">
                        <h2 class="mb-2">
                            <i class="ph ph-calendar-plus me-2"></i>{{ __('events_general.create_event') }}
                        </h2>
                    <p class="text-secondary mb-0">{{ __('events_general.create_event_help') }}</p>
                </div>
                    </div>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            @else
                                <button type="button"
                                    ...
                                    <i class="ph ph-check-circle me-2"></i>{{ __('events_general.create_event_button') }}
                                </button>
                            @endif
