                    ...
                    <form wire:submit="save">
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <span class="badge bg-primary">{{ count($invitedUsers) }}</span>
                            </div>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="list-group list-group-flush">
                                            ...
                                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                                ...
                                                <button type="button" class="btn btn-sm btn-primary" wire:click="addUserToInviteList({{ $user['id'] }})">
                                                    <i class="ph-duotone ph-plus me-1"></i>{{ __('groups.invite') }}
                                                </button>
                                            </div>
                                            @endforeach
                                        </div>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="list-group list-group-flush">
                                            ...
                                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger" wire:click="removeInvitedUser({{ $user['id'] }})">
                                                    <i class="ph-duotone ph-x"></i>
                                                </button>
                                            </div>
                                            @endforeach
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary" wire:loading.attr="disabled">
                                ...
                                <span wire:loading.remove>{{ __('groups.create') }}</span>
                                <span wire:loading>{{ __('groups.creating') }}</span>
                            </button>
