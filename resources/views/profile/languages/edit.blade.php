...
@section('title', __('languages.edit_language'))
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12 col-md-8 col-lg-6">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('profile.languages.update', $userLanguage) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="custom-language-dropdown">
                                <div class="dropdown-toggle @error('language_name') is-invalid @enderror" id="languageDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="flag-icon flag-icon-{{ \App\Providers\LanguageServiceProvider::getFlagCode($userLanguage->language_code) }} me-2"></i>
                                    <span id="selectedLanguageName">{{ $userLanguage->language_name }}</span>
                                ...
                                <input type="hidden" name="language_name" id="language_name" value="{{ old('language_name', $userLanguage->language_name) }}">
                                <input type="hidden" name="language_code" id="language_code" value="{{ old('language_code', $userLanguage->language_code) }}">
                            </div>
                            @error('language_name')
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input"
                                               ...
                                               id="type_native"
                                               value="native"
                                               {{ old('type', $userLanguage->type) === 'native' ? 'checked' : '' }}
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input"
                                               ...
                                               id="type_spoken"
                                               value="spoken"
                                               {{ old('type', $userLanguage->type) === 'spoken' ? 'checked' : '' }}
                                               onchange="toggleLevelField()">
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input"
                                               ...
                                               id="type_written"
                                               value="written"
                                               {{ old('type', $userLanguage->type) === 'written' ? 'checked' : '' }}
                                               onchange="toggleLevelField()">
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input"
                                               ...
                                               id="level_excellent"
                                               value="excellent"
                                               {{ old('level', $userLanguage->level) === 'excellent' ? 'checked' : '' }}>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input"
                                               ...
                                               id="level_good"
                                               value="good"
                                               {{ old('level', $userLanguage->level) === 'good' ? 'checked' : '' }}>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input"
                                               ...
                                               id="level_poor"
                                               value="poor"
                                               {{ old('level', $userLanguage->level) === 'poor' ? 'checked' : '' }}>
