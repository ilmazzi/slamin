...
namespace App\Models\Chat\Concerns;
...
trait HasDynamicIds
{
    ...
    {
        $this->usesUniqueIds = ChatHelper::usesUuid();
    }
    ...
    {
        return ChatHelper::usesUuid() ? 'string' : 'int';
    }
