...
class Group extends Model
{
    ...
    {
        $this->table = ChatHelper::formatTableName('groups');
    ...
    protected static function boot()
    {
        ...
        static::deleted(function ($group) {
            ...
            if ($group->cover?->exists()) {
                ...
                if (Storage::disk(ChatHelper::storageDisk())->exists($group->cover->file_path)) {
                    Storage::disk(ChatHelper::storageDisk())->delete($group->cover->file_path);
                }
            }
