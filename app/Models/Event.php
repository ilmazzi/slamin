...
class Event extends Model
{
    ...
    public function getCategoryColorClassAttribute(): string
    {
        return match($this->category) {
            ...
            self::CATEGORY_BOOK_PRESENTATION => 'bg-success',
            self::CATEGORY_READING => 'bg-info',
    ...
    public function getCategoryLightColorClassAttribute(): string
    {
        return match($this->category) {
            ...
            self::CATEGORY_BOOK_PRESENTATION => 'bg-light-success',
            self::CATEGORY_READING => 'bg-light-info',
