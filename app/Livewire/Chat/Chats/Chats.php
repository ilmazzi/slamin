...
namespace App\Livewire\Chat\Chats;
...
class Chats extends Component
{
    ...
    public function mount(
        ...
        $this->showNewChatModalButton = isset($showNewChatModalButton) ? $showNewChatModalButton : ChatHelper::showNewChatModalButton();
        $this->allowChatsSearch = isset($allowChatsSearch) ? $allowChatsSearch : ChatHelper::allowChatsSearch();
        $this->showHomeRouteButton = isset($showHomeRouteButton) ? $showHomeRouteButton : ! $this->widget;
        $this->title = isset($title) ? $title : __('chat::chats.labels.heading');
    ...
    public function render()
    {
        ...
        return view('chat::livewire.chats.chats');
    }
}
