...
namespace App\Livewire\Chat\Chat\Group;
...
class Info extends ModalComponent
{
    ...
    {
        return [
            'groupName.required' => __('chat::validation.required', ['attribute' => __('chat::chat.group.info.inputs.name.label')]),
            'groupName.max' => __('chat::validation.max.string', ['attribute' => __('chat::chat.group.info.inputs.name.label')]),
            'description.max' => __('chat::validation.max.string', ['attribute' => __('chat::chat.group.info.inputs.description.label')]),
            'photo.max' => __('chat::validation.max.file', ['attribute' => __('chat::chat.group.info.inputs.photo.label')]),
            'photo.image' => __('chat::validation.image', ['attribute' => __('chat::chat.group.info.inputs.photo.label')]),
            'photo.mimes' => __('chat::validation.mimes', ['attribute' => __('chat::chat.group.info.inputs.photo.label')]),
        ];
    }
    ...
    public function mount()
    {
        ...
        abort_unless(auth()->check(), 401);
        abort_unless($this->conversation->isGroup(), 403, __('chat::chat.info.group.messages.invalid_conversation_type_error'));
    ...
    public function render()
    {
        ...
        return view('chat::livewire.chat.group.info', [
