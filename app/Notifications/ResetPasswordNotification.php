...
class ResetPasswordNotification extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ...
            ->line(__('auth.reset_password_email_line1'))
            ->action(__('auth.reset_password_email_action'), $url)
            ->line(__('auth.reset_password_email_line2'))
            ->line(__('auth.reset_password_email_line3'))
            ->salutation(__('auth.reset_password_email_salutation'));
    }
