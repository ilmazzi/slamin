    ...
    public function update(Request $request)
    {
        ...
        try {
            $request->validate([
                ...
                'precise_address' => 'nullable|string|max:500',
                'public_location' => 'nullable|string|max:255',
                'city' => 'nullable|string|max:100',
                'region' => 'nullable|string|max:100',
                'country' => 'nullable|string|max:100',
                'location_privacy' => 'nullable|in:public,region,country,private,custom',
        ...
        $user->update([
            ...
            'precise_address' => $request->precise_address,
            'public_location' => $request->public_location,
            'city' => $request->city,
            'region' => $request->region,
            'country' => $request->country,
            'location_privacy' => $request->location_privacy,
