    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="text-center mb-4">
                <h2 class="mb-2">
                    <i class="ph ph-calendar-plus me-2"></i><?php echo e(__('events.create_event')); ?> Slam in
                </h2>
                                ...
                                <div id="groupFields" style="display: none;">
                                    ...
                                    <div class="form-floating mb-3">
                                        <select name="group_id" id="group_id" class="form-select">
                                            ...
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            <option value="" disabled>Nessun gruppo disponibile</option>
                                        <?php endif; ?>
                                        </select>
                                        <label for="group_id"><?php echo e(__('events.select_group')); ?></label>
                                    </div>
...
function setupEventListeners() {
    ...
    if (groupSelect) {
        groupSelect.addEventListener('change', function() {
            ...
            console.log('Gruppo selezionato:', selectedGroupId);
            
            // Qui puoi aggiungere logica aggiuntiva se necessario
            // Per esempio, aggiornare altri campi basati sul gruppo selezionato
        });
    }
...
function validateCurrentStep() {
    ...
    if (step === 2) {
        ...
        // Validazione per selezione gruppo (opzionale)
        const isLinkedToGroup = document.getElementById('is_linked_to_group');
        if (isLinkedToGroup && isLinkedToGroup.checked) {
            const groupId = document.getElementById('group_id');
            if (!groupId || !groupId.value) {
                showError('group_id', 'Seleziona un gruppo');
                highlightError('group_id');
                isValid = false;
            } else {
                // Verifica che il gruppo selezionato sia valido
                const selectedOption = groupId.options[groupId.selectedIndex];
                if (selectedOption && selectedOption.value === '') {
                    showError('group_id', 'Seleziona un gruppo valido');
                    highlightError('group_id');
                    isValid = false;
                }
            }
        ...
        <div class="card mb-3" id="${positionId}">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label"><?php echo e(__('common.language_selector')); ?> richiesta (opzionale)</label>
