                ...
                <div class="card-body p-0">
                    <?php if($mostPopularVideo): ?>
                        <div class="position-relative">
                            <?php if($mostPopularVideo->thumbnail_url && $mostPopularVideo->thumbnail_url !== asset('assets/images/placeholder/placeholder-1.jpg')): ?>
                        ...
                        <div class="card-body">
                            <h5 class="card-title f-w-600 f-s-16 mb-2"><?php echo e($mostPopularVideo->title); ?></h5>
                            ...
                            <?php $__currentLoopData = $popularVideos->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                                    <div class="flex-shrink-0 position-relative" style="cursor: pointer;" onclick="window.location.href='<?php echo e(route('videos.show', $video)); ?>'">
                                        <?php if($video->thumbnail_url && $video->thumbnail_url !== asset('assets/images/placeholder/placeholder-1.jpg')): ?>
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 f-w-600 f-s-13"><?php echo e(Str::limit($video->title, 40)); ?></h6>
