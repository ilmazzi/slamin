                ...
                <div class="card bg-primary text-white hover-effect">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="text-white mb-1 f-w-600"><?php echo e(__('dashboard.welcome', ['name' => $user->getDisplayName()])); ?></h4>
                                <p class="text-white-50 mb-2 f-s-14"><?php echo e($user->email); ?></p>
