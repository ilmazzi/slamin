    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="mb-0 f-w-600"><?php echo e(__('profile.video_management')); ?></h4>
                <a href="<?php echo e(route('videos.upload')); ?>" class="btn btn-primary hover-effect">
                    <i class="ph ph-plus me-2"></i><?php echo e(__('profile.upload_new_video')); ?>
        ...
        <div class="modal-content">
            <div class="modal-header card-light-primary">
                <h5 class="modal-title f-w-600">
                    ...
                    <?php echo e(__('profile.upload_new_video')); ?>
...
function deleteVideo(videoId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch(`<?php echo e(route('profile.videos.delete', ':videoId')); ?>`.replace(':videoId', videoId), {
                method: 'DELETE',
                headers: {
