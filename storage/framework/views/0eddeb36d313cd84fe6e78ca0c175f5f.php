<?php $__env->startSection('title', __('videos.upload_video')); ?>
...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row m-1">
            <div class="col-12">
                <h4 class="main-title"><?php echo e(__('videos.upload_video')); ?></h4>
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="">
                        <a href="<?php echo e(route('videos.index')); ?>" class="f-s-14 f-w-500">
                            <span>
                    ...
                    <li class="active">
                        <a href="#" class="f-s-14 f-w-500"><?php echo e(__('videos.upload_video')); ?></a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-md-6 mb-3 mb-md-0">
                                <h6 class="mb-2">
                                    ...
                                    <?php echo e(__('videos.upload_status')); ?>

                                </h6>
                                <p class="mb-0 text-muted">
                                    <?php echo e(__('videos.videos_remaining')); ?>: <strong><?php echo e($user->remaining_video_uploads); ?></strong>
                                </p>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="progress mb-2" style="height: 8px;">
                                    <div class="progress-bar bg-success" style="width: <?php echo e(($user->current_video_count / $user->current_video_limit) * 100); ?>%"></div>
                                </div>
                                <small class="text-muted">
                                    <?php echo e($user->current_video_count); ?> / <?php echo e($user->current_video_limit); ?> <?php echo e(__('videos.videos_used')); ?>
            ...
            <div class="col-12">
                <div class="alert alert-info">
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            <h6 class="alert-heading mb-2"><?php echo e(__('videos.upload_info')); ?></h6>
                            <p class="mb-2">Il tuo video verrà caricato su PeerTube e sarà disponibile a breve una volta completata la finalizzazione.</p>
                            <ul class="mb-0 small">
                                <li><?php echo e(__('videos.supported_formats')); ?></li>
                                <li><?php echo e(__('videos.max_size')); ?></li>
                                <li><?php echo e(__('videos.processing_time')); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            ...
                            <?php echo e(__('videos.upload_form')); ?>

                        </h5>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo e(route('videos.store')); ?>" method="POST" enctype="multipart/form-data" id="uploadForm">
                            <?php echo csrf_field(); ?>

                            <!-- <?php echo e(__('common.video')); ?> File Upload with Integrated Progress -->
                            <div class="row mb-4">
                                <div class="col-12">
                                    <label for="videoFile" class="form-label"><?php echo e(__('videos.video_file')); ?> *</label>
                                    <div class="upload-area border-2 border-dashed border-secondary rounded p-4 text-center position-relative" id="uploadArea">
                                        ...
                                        <div id="uploadState">
                                            ...
                                            <h6 class="mb-2"><?php echo e(__('videos.drag_drop_video')); ?></h6>
                                            <p class="text-muted mb-3"><?php echo e(__('videos.supported_formats')); ?>: MP4, AVI, MOV, MKV, WEBM, FLV</p>
                                            <p class="text-muted f-s-12"><?php echo e(__('videos.max_size')); ?>: 100MB</p>
                                            ...
                                            <button type="button" class="btn btn-outline-success" onclick="document.getElementById('videoFile').click()">
                                                <i class="ph-duotone ph-folder-open me-2"></i><?php echo e(__('videos.select_file')); ?>
                                        ...
                                        <div id="progressState" style="display: none;">
                                            <div class="d-flex align-items-center justify-content-center mb-3">
                                                <div class="spinner-border spinner-border-sm text-success me-3" role="status">
                                                    <span class="visually-hidden"><?php echo e(__('videos.loading')); ?></span>
                                                </div>
                                                <h6 class="mb-0" id="progressTitle"><?php echo e(__('videos.preparing_upload')); ?></h6>
                                            </div>
                            ...
                            <!-- <?php echo e(__('common.video')); ?> Details - Mobile First Layout -->
                            <div class="row">
                                <!-- Title -->
                                <div class="col-12 mb-3">
                                    <label for="title" class="form-label"><?php echo e(__('videos.title')); ?> *</label>
                                    <input type="text" class="form-control" id="title" name="title" value="<?php echo e(old('title')); ?>" required maxlength="255">
                                    <div class="form-text"><?php echo e(__('videos.title_help')); ?></div>
                                </div>

                                <!-- Description -->
                                <div class="col-12 mb-3">
                                    <label for="description" class="form-label"><?php echo e(__('videos.description')); ?></label>
                                    <textarea class="form-control" id="description" name="description" rows="4" maxlength="1000"><?php echo e(old('description')); ?></textarea>
                                    <div class="form-text"><?php echo e(__('videos.description_help')); ?></div>
                                </div>

                                <!-- Tags -->
                                <div class="col-12 mb-3">
                                    <label for="tags" class="form-label"><?php echo e(__('videos.tags')); ?></label>
                                    <input type="text" class="form-control" id="tags" name="tags" value="<?php echo e(old('tags')); ?>" placeholder="<?php echo e(__('videos.tags_placeholder')); ?>">
                                    <div class="form-text"><?php echo e(__('videos.tags_help')); ?></div>
                                </div>

                                <!-- <?php echo e(__('common.thumbnail')); ?> -->
                                <div class="col-12 mb-3">
                                    <label for="thumbnail" class="form-label"><?php echo e(__('videos.thumbnail')); ?></label>
                                    <div class="thumbnail-upload" id="thumbnailArea">
                                        <div class="thumbnail-placeholder text-center p-3 border rounded">
                                            ...
                                            <p class="text-muted small mb-2"><?php echo e(__('videos.thumbnail_help')); ?></p>
                                            <button type="button" class="btn btn-sm btn-outline-success" onclick="document.getElementById('thumbnail').click()">
                                                <?php echo e(__('videos.select_thumbnail')); ?>
                                        ...
                                        <div class="thumbnail-preview d-none" id="thumbnailPreview">
                                            <img src="" alt="<?php echo e(__('common.thumbnail')); ?>" class="img-fluid rounded" id="thumbnailImg">
                                ...
                                <!-- Privacy -->
                                <div class="col-12 mb-3">
                                    <label class="form-label"><?php echo e(__('videos.privacy')); ?></label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_public" id="public" value="1" <?php echo e(old('is_public', '1') == '1' ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="public">
                                            <i class="ph-duotone ph-globe f-s-14 me-1"></i>
                                            <?php echo e(__('videos.public')); ?>

                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_public" id="private" value="0" <?php echo e(old('is_public') == '0' ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="private">
                                            <i class="ph-duotone ph-lock f-s-14 me-1"></i>
                                            <?php echo e(__('videos.private')); ?>
                                ...
                                <div class="col-12">
                                    <div class="d-flex flex-column flex-sm-row justify-content-between gap-2">
                                        ...
                                        <button type="submit" class="btn btn-success" id="submitBtn" disabled>
                                            ...
                                            <?php echo e(__('videos.upload_video')); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    uploadForm.addEventListener('submit', function(e) {
        ...
        submitBtn.disabled = true;
                        submitBtn.innerHTML = '<i class="ph-duotone ph-spinner f-s-16 me-1"></i><?php echo e(__("videos.loading")); ?>';
        ...
        const connectionLabels = {
            'slow-2g': 'Molto Lenta',
            '2g': 'Lenta',
            '3g': '<?php echo e(__('common.media_section')); ?>',
            '4g': 'Veloce',
            '5g': 'Molto Veloce'
        };
        ...
        .then(response => {
            ...
            progressText.textContent = '<?php echo e(__('common.video')); ?> caricato con successo';
        ...
        .catch(error => {
            ...
            submitBtn.disabled = false;
            submitBtn.innerHTML = '<i class="ph-duotone ph-upload me-1"></i><?php echo e(__('videos.upload_video')); ?>';

            // Show error with SweetAlert if available
            if (typeof Swal !== 'undefined') {
                Swal.fire({
                    icon: 'error',
                    title: '<?php echo e(__("videos.upload_error")); ?>',
                    text: error.message,
                    confirmButtonText: 'OK'
                });
            } else {
                alert('<?php echo e(__("videos.upload_error_message")); ?>' + error.message);
            }
        });
    });

    // <?php echo e(__('common.thumbnail')); ?> handling
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\slamin\resources\views/videos/upload.blade.php ENDPATH**/ ?>