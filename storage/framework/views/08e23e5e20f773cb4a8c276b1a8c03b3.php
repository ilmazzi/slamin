        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-warning" onclick="submitReport()"><?php echo e(__('articles.report')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
function submitReport() {
    ...
    fetch('<?php echo e(route('articles.reports.store', $article)); ?>', {
        method: 'POST',
        headers: {
