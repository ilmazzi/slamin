<?php $__env->startSection('title', __('admin.edit_translations_title', ['language' => strtoupper($language), 'file' => $file])); ?>
...
<h3><?php echo e(__('admin.edit_translations_title', ['language' => strtoupper($language), 'file' => $file])); ?></h3>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb-items'); ?>
<li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('dashboard.dashboard')); ?></a></li>
<li class="breadcrumb-item"><a href="<?php echo e(route('admin.translations.index')); ?>"><?php echo e(__('admin.translation_management')); ?></a></li>
<li class="breadcrumb-item active"><?php echo e(strtoupper($language)); ?> - <?php echo e($file); ?></li>
<?php $__env->stopSection(); ?>
...
<div class="container-fluid">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h5 class="mb-1">
                                ...
                                <?php echo e(strtoupper($language)); ?> - <?php echo e($file); ?>

                            </h5>
                            <p class="text-muted mb-0 f-s-14">
                                Gestisci le traduzioni per il file <?php echo e($file); ?> in <?php echo e(strtoupper($language)); ?>

                            </p>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex justify-content-end gap-2">
                                <a href="<?php echo e(route('admin.translations.index')); ?>" class="btn btn-light-secondary">
                                    <i class="ph ph-arrow-left me-1"></i><?php echo e(__('admin.back_to_list')); ?>
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body text-center">
                            <div class="f-s-24 f-w-600 text-primary"><?php echo e(count($flattenedReferenceTranslations)); ?></div>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body text-center">
                            <div class="f-s-24 f-w-600 text-success" id="translatedCount">
                                <?php echo e(count(array_filter($flattenedTranslations, function($value) { return !empty($value); }))); ?>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body text-center">
                            <div class="f-s-24 f-w-600 text-info" id="progressPercent">
                                <?php echo e(count($flattenedReferenceTranslations) > 0 ? round((count(array_filter($flattenedTranslations, function($value) { return !empty($value); })) / count($flattenedReferenceTranslations)) * 100) : 0); ?>%
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="filter-buttons">
                                <button type="button" class="btn btn-outline-primary btn-sm active" data-filter="all">
                                    Tutte (<?php echo e(count($flattenedReferenceTranslations)); ?>)
                                </button>
                                <button type="button" class="btn btn-outline-success btn-sm" data-filter="translated">
                                    Tradotte (<span id="translatedFilterCount"><?php echo e(count(array_filter($flattenedTranslations, function($value) { return !empty($value); }))); ?></span>)
                                </button>
                                <button type="button" class="btn btn-outline-warning btn-sm" data-filter="missing">
                                    Mancanti (<span id="missingFilterCount"><?php echo e(count($missingKeys ?? [])); ?></span>)
                                </button>
                                <button type="button" class="btn btn-outline-info btn-sm" data-filter="untranslated">
                                    Da Tradurre (<span id="untranslatedFilterCount"><?php echo e(count($flattenedReferenceTranslations) - count(array_filter($flattenedTranslations, function($value) { return !empty($value); })) - count($missingKeys ?? [])); ?></span>)
                                </button>
                            </div>
                        </div>
                        <div class="col-md-4">
    ...
    <!-- Form di traduzione -->
    <form id="translationForm" action="<?php echo e(route('admin.translations.update', [$language, $file])); ?>" method="POST">
        <?php echo csrf_field(); ?>
                            ...
                            <table class="table table-hover mb-0">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th style="width: 35%;" class="f-s-12 f-w-500">Traduzione (<?php echo e(strtoupper($language)); ?>)</th>
                                    </tr>
                                </thead>
                                <tbody id="translationTableBody">
                                    <?php $__currentLoopData = $flattenedReferenceTranslations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $referenceValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    ?>
                                    <tr class="translation-row <?php echo e($statusClass); ?>" data-key="<?php echo e($key); ?>" data-status="<?php echo e($isMissing ? 'missing' : ($isTranslated ? 'translated' : 'untranslated')); ?>">
                                        <td class="align-top py-3">
                                            <div class="d-flex flex-column gap-1">
                                                <span class="key-badge"><?php echo e($key); ?></span>
                                                <span class="status-badge <?php echo e($isMissing ? 'bg-warning text-dark' : ($isTranslated ? 'bg-success text-white' : 'bg-primary text-white')); ?>">
                                                    <?php echo e($isMissing ? 'Mancante' : ($isTranslated ? 'Tradotta' : 'Da tradurre')); ?>

                                                </span>
                                            </div>
                                        </td>
                                        <td class="align-top py-3">
                                            <div class="reference-text"><?php echo e($referenceValue); ?></div>
                                        </td>
                                        <td class="align-top py-3">
                                            <textarea name="translations[<?php echo e($key); ?>]"
                                                      ...
                                                      data-reference="<?php echo e($referenceValue); ?>"
                                                      onchange="updateProgress()"><?php echo e($flattenedTranslations[$key] ?? ''); ?></textarea>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\slamin\resources\views/admin/translations/edit.blade.php ENDPATH**/ ?>