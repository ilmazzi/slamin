                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-1"><?php echo e(__('gigs.stats.total_gigs')); ?></h6>
                                <h4 class="mb-0"><?php echo e(number_format($stats['total_gigs'])); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <h4 class="mb-0"><?php echo e(number_format($stats['open_gigs_count'])); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-light-warning">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-1"><?php echo e(__('gigs.stats.urgent_gigs_count')); ?></h6>
                                <h4 class="mb-0"><?php echo e(number_format($stats['urgent_gigs_count'])); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                <form method="GET" action="<?php echo e(route('gigs.index')); ?>" class="row g-3">
                    <div class="col-lg-4 col-md-6">
                        <label for="search" class="form-label"><?php echo e(__('gigs.filters.search')); ?></label>
                        <input type="text" class="form-control" id="search" name="search"
                               value="<?php echo e(request('search')); ?>"
                               placeholder="<?php echo e(__('gigs.filters.search')); ?>">
                    </div>
                    <div class="col-lg-2 col-md-6">
                        <label for="category" class="form-label"><?php echo e(__('gigs.filters.filter_by_category')); ?></label>
                    ...
                    <div class="col-lg-2 col-md-6">
                        <label for="type" class="form-label"><?php echo e(__('gigs.filters.filter_by_type')); ?></label>
                    ...
                    <div class="col-lg-2 col-md-6">
                        <label for="sort" class="form-label"><?php echo e(__('gigs.filters.sort_by')); ?></label>
                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('gigs.index')); ?>" class="btn btn-light">
                                    ...
                                    <div class="card-body d-flex flex-column p-3">
                                        ...
                                        <div class="mt-auto">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="<?php echo e(route('gigs.create')); ?>?event=<?php echo e($event->id); ?>" class="btn btn-outline-primary btn-sm">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <a href="<?php echo e(route('gigs.my-gigs')); ?>" class="btn btn-outline-primary">
                    ...
                    <div class="card equal-card">
                        <div class="card-body">
                            ...
                            <div class="row text-center mb-3">
                                <div class="col-4">
                                    <small class="text-muted d-block"><?php echo e(__('gigs.stats.applications')); ?></small>
                                    <?php if($gig->application_count > 0): ?>
                                        <a href="<?php echo e(route('gigs.manage-applications', $gig)); ?>" class="text-decoration-none">
                                            <strong class="text-primary"><?php echo e($gig->application_count); ?></strong>
                                            <i class="ph ph-arrow-right ms-1"></i>
                                        </a>
                                    <?php else: ?>
                                        <strong><?php echo e($gig->application_count); ?></strong>
                                    <?php endif; ?>
                                </div>
                                <div class="col-4">
                                    <small class="text-muted d-block"><?php echo e(__('gigs.stats.accepted_applications_count')); ?></small>
                                    <strong class="text-success"><?php echo e($gig->accepted_applications_count); ?></strong>
                                </div>
                                <div class="col-4">
                                    <small class="text-muted d-block"><?php echo e(__('gigs.fields.deadline')); ?></small>
                                    <strong><?php echo e($gig->deadline ? $gig->deadline->format('d/m/Y') : 'N/A'); ?></strong>
                                </div>
                            </div>
