<?php $__env->startSection('title', 'Ingaggi'); ?>
...
<div class="page-content">
    <div class="container-fluid">
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-2">
                                ...
                                <h4 class="mb-0 f-s-18 f-w-600"><?php echo e(number_format($stats['total_gigs'] ?? 0)); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-2">
                                ...
                                <h4 class="mb-0 f-s-18 f-w-600"><?php echo e(number_format($stats['open_gigs_count'] ?? 0)); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-2">
                                ...
                                <h4 class="mb-0 f-s-18 f-w-600"><?php echo e(number_format($stats['urgent_gigs_count'] ?? 0)); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-2">
                                ...
                                <h4 class="mb-0 f-s-18 f-w-600"><?php echo e(number_format(isset($gigs) ? $gigs->sum('application_count') : 0)); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form method="GET" action="<?php echo e(route('gigs.index')); ?>" class="row g-3">
                    ...
                    <div class="col-12 col-md-6 col-lg-2">
                        ...
                        <select class="form-select form-select-sm" id="sort" name="sort">
                            <?php if(isset($sortOptions) && is_array($sortOptions)): ?>
        ...
        <div class="row mt-4">
                    ...
                    <div class="card hover-effect mb-3">
                        <div class="card-body p-3">
                            ...
                            <p class="card-text text-muted f-s-12 mb-3">
                                ...
                                ?>
                                <?php echo e(Str::limit($gigDescription, 100)); ?>
                            ...
                            <div class="mb-3">
                                <span class="badge bg-light-primary me-1 f-s-10">
                                    ...
                                    ?>
                                    <?php echo e($categoryTranslation); ?>
                            ...
                            <div class="row text-center mb-3 g-2">
                                <div class="col-4">
                                    ...
                                    <?php if((int)($gig->application_count ?? 0) > 0): ?>
                                        <a href="<?php echo e(route('gigs.manage-applications', $gig)); ?>" class="text-decoration-none">
                                            <strong class="text-primary f-s-12"><?php echo e((int)($gig->application_count ?? 0)); ?></strong>
                                            <i class="ph ph-arrow-right ms-1 f-s-10"></i>
                                        </a>
                                    <?php else: ?>
                                        <strong class="f-s-12"><?php echo e((int)($gig->application_count ?? 0)); ?></strong>
                                    <?php endif; ?>
                                </div>
                                <div class="col-4">
                                    <small class="text-muted d-block f-s-10">Accettate</small>
                                    <strong class="text-success f-s-12"><?php echo e((int)($gig->accepted_applications_count ?? 0)); ?></strong>
                                </div>
                                <div class="col-4">
                            ...
                            <!-- Azioni -->
                            <div class="d-flex flex-column flex-sm-row gap-2">
                                <?php if(isset($gig->poem) && $gig->poem): ?>
                                    <a href="<?php echo e(route('poems.show', $gig->poem->slug)); ?>" class="btn btn-outline-primary btn-sm">
                                    ...
                                    <?php if($isOwner): ?>
                                        ...
                                        <?php if($hasAcceptedApplication): ?>
                                            <a href="<?php echo e(route('translations.payment.show', $hasAcceptedApplication)); ?>" class="btn btn-success btn-sm">
                                                <i class="fas fa-credit-card me-1"></i>Pagamento
                                            </a>
                                        <?php elseif($gig->applications_count > 0): ?>
                                            <a href="<?php echo e(route('gigs.manage-applications', $gig)); ?>" class="btn btn-info btn-sm">
                                    ...
                                    <?php elseif($userApplication): ?>
                                        ...
                                        <?php if($userApplication->status === 'accepted'): ?>
                                            <a href="<?php echo e(route('translations.payment.show', $userApplication)); ?>" class="btn btn-success btn-sm">
                                                <i class="fas fa-credit-card me-1"></i>Pagamento
                                            </a>
                                        <?php elseif($userApplication->status === 'pending'): ?>
                                            <a href="<?php echo e(route('translations.negotiation.show', $userApplication)); ?>" class="btn btn-info btn-sm">
                                        ...
                                        <?php endif; ?>
                                    <?php elseif($gig->canUserApply(auth()->user())): ?>
                                        ...
                                        <button type="button" class="btn btn-primary btn-sm"
                                                ...
                                                data-gig-type="gig"
                                                data-gig-title="<?php echo e($gigTitle); ?>"
                                                data-gig-compensation="<?php echo e($gig->compensation); ?>">
            ...
            <?php if(!isset($gigs) || $gigs->count() == 0): ?>
                <div class="col-12">
                    <div class="card">
        ...
        <!-- Paginazione -->
        <?php if(isset($gigs) && $gigs->hasPages()): ?>
            <div class="row">
                <div class="col-12">
