...
<div class="card hover-effect mt-3 social-comments-section" 
    ...
    <div class="card-body">
        ...
        <div class="alert alert-info">
            ...
            <a href="<?php echo e(route('login')); ?>">Accedi</a> per lasciare un commento.
        </div>
        <?php endif; ?>
                    ...
                    <div class="d-flex align-items-start">
                        <div class="h-45 w-45 d-flex-center b-r-50 overflow-hidden bg-primary me-3">
                            <?php if($comment->user->profile_photo): ?>
                                <img src="<?php echo e($comment->user->profile_photo_url); ?>" alt="" class="img-fluid">
                            <?php else: ?>
                                <span class="text-white fw-bold"><?php echo e(substr($comment->user->name, 0, 2)); ?></span>
                            <?php endif; ?>
                        </div>
                        <div class="flex-grow-1">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                ...
                                <?php if(auth()->id() === $comment->user_id || (auth()->user() && auth()->user()->hasRole('admin'))): ?>
                                <div class="dropdown">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.social-like-button','data' => ['content' => $comment,'type' => 'comment']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['content' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($comment),'type' => 'comment']); ?>
...
</script> <?php /**PATH C:\xampp\htdocs\slamin\resources\views/components/social-comments-section.blade.php ENDPATH**/ ?>