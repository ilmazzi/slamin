            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-center gap-2 mb-4">
                        <button class="btn btn-primary icon-btn" onclick="toggleLike()" id="likeBtn" title="<?php echo e(__('poems.actions.like')); ?>">
                            <i class="ph <?php echo e($poem->is_liked_by_current_user ? 'ph-heart-fill text-danger' : 'ph-heart'); ?>"></i>
                        </button>
                    ...
                    <div class="d-flex justify-content-center gap-4 mb-4">
                        <div class="text-center">
                            <div class="social-counter" style="display: flex; flex-direction: column; align-items: center; gap: 4px; padding: 8px; border-radius: 8px;">
                                ...
                                <span class="text-secondary f-s-12"><?php echo e(number_format($poem->like_count)); ?></span>
                            </div>
                        </div>
                        <div class="text-center">
                            <div class="social-counter" style="display: flex; flex-direction: column; align-items: center; gap: 4px; padding: 8px; border-radius: 8px;">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info mb-4">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="text-decoration-none">Accedi</a> per lasciare un commento e interagire con la poesia.
                    </div>
                    <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const originalData = {
        title: '<?php echo e(addslashes($poem->title)); ?>',
        content: `<?php echo addslashes(nl2br(e($poem->content))); ?>`,
        description: '<?php echo e(addslashes($poem->description ?? '')); ?>'
    };
