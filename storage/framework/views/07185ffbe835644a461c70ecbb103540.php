    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-8 order-1 order-lg-1">
            <?php if(!$showAllArticles): ?>
                ...
                <?php if(isset($layoutArticles) && count($layoutArticles) > 0): ?>
                    <div class="mb-4">
                        <h4 class="mb-3 f-s-18 f-w-600">
                            <i class="ph ph-star me-2"></i>
                            <?php echo e(__('articles.editor_picks')); ?>
                        ...
                        <?php if(isset($layoutArticles['horizontal1'])): ?>
                            <div class="row g-3 mb-4">
                                <div class="col-12">
                                    <?php $article = $layoutArticles['horizontal1']; ?>
                                    <div class="card hover-effect">
                                        <div class="position-relative">
                                            ...
                                            <?php else: ?>
                                                <?php echo PlaceholderHelper::getArticlePlaceholderHtml(0, 250, 'card-img-top', route('articles.show', $article->slug)); ?>
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title f-s-18 f-w-600 mb-3"><?php echo e($article->title); ?></h5>
                                            <p class="card-text f-s-14 text-muted mb-3"><?php echo e(Str::limit($article->excerpt, 150)); ?></p>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="d-flex gap-3 text-muted f-s-12">
                                                    <span><i class="ph ph-user me-1"></i><?php echo e($article->user->name ?? 'N/A'); ?></span>
                                                    <span><i class="ph ph-calendar me-1"></i><?php echo e($article->published_at->format('d/m/Y')); ?></span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.social-like-button','data' => ['content' => $article,'type' => 'article','size' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.social-comment-button','data' => ['content' => $article,'type' => 'article','size' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                                ...
                                                <a href="<?php echo e(route('articles.show', $article->slug)); ?>" class="btn btn-primary">
                        ...
                        <!-- Column Articles 1 & 2 -->
                        <?php if(isset($layoutArticles['column1']) || isset($layoutArticles['column2'])): ?>
                            <div class="row g-3 mb-4">
                                <?php if(isset($layoutArticles['column1'])): ?>
                                    <div class="col-12 col-sm-6">
                                        <?php $article = $layoutArticles['column1']; ?>
                                            ...
                                            <div class="position-relative">
                                                <?php if($article->featured_image_url): ?>
                                                    <img src="<?php echo e($article->featured_image_url); ?>"
                                                         ...
                                                         alt="<?php echo e($article->title); ?>">
                                                <?php else: ?>
                                                    <?php echo PlaceholderHelper::getArticlePlaceholderHtml(0, 200, 'card-img-top', route('articles.show', $article->slug)); ?>

                                                <?php endif; ?>
                                                <?php if($article->category): ?>
                                                    <div class="position-absolute top-0 start-0 m-2">
                                                        <span class="badge bg-primary"><?php echo e($article->category->name); ?></span>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                            <div class="card-body d-flex flex-column">
                                                <h6 class="card-title f-s-15 f-w-600 mb-2"><?php echo e(Str::limit($article->title, 50)); ?></h6>
                                                <p class="card-text f-s-13 text-muted mb-3"><?php echo e(Str::limit($article->excerpt, 70)); ?></p>
                                                <div class="mt-auto">
                                                    <div class="d-flex justify-content-between align-items-center">
...
<?php endif; ?>
                                                        ...
                                                        <a href="<?php echo e(route('articles.show', $article->slug)); ?>" class="btn btn-outline-primary btn-sm">
                                                            <?php echo e(__('articles.read_more')); ?>
...
<?php endif; ?>
                        ...
                        <?php if(isset($layoutArticles['horizontal2'])): ?>
                            <div class="row g-3 mb-4">
                                <div class="col-12">
                                    <?php $article = $layoutArticles['horizontal2']; ?>
                                    <div class="card hover-effect">
                                        <div class="position-relative">
                                            <?php if($article->featured_image_url): ?>
                                                <img src="<?php echo e($article->featured_image_url); ?>"
...
<?php endif; ?>
                        ...
                        <!-- Column Articles 3 & 4 -->
                        <?php if(isset($layoutArticles['column3']) || isset($layoutArticles['column4'])): ?>
                            <div class="row g-3 mb-4">
                                <?php if(isset($layoutArticles['column3'])): ?>
                                    <div class="col-12 col-sm-6">
                                        <?php $article = $layoutArticles['column3']; ?>
                                        <div class="card hover-effect h-100">
                                            <div class="position-relative">
                                                <?php if($article->featured_image_url): ?>
                                                    <img src="<?php echo e($article->featured_image_url); ?>"
...
<?php endif; ?>
                        ...
                        <?php if(isset($layoutArticles['horizontal3'])): ?>
                            <div class="row g-3 mb-4">
                                <div class="col-12">
                                    <?php $article = $layoutArticles['horizontal3']; ?>
                                    <div class="card hover-effect">
                                        <div class="position-relative">
                                            <?php if($article->featured_image_url): ?>
                                                <img src="<?php echo e($article->featured_image_url); ?>"
...
<?php endif; ?>
                        ...
                        <!-- Column Articles 5 & 6 -->
                        <?php if(isset($layoutArticles['column5']) || isset($layoutArticles['column6'])): ?>
                            <div class="row g-3 mb-4">
                                <?php if(isset($layoutArticles['column5'])): ?>
                                    <div class="col-12 col-sm-6">
                                        <?php $article = $layoutArticles['column5']; ?>
                                        <div class="card hover-effect h-100">
                                            <div class="position-relative">
                                                <?php if($article->featured_image_url): ?>
                                                    <img src="<?php echo e($article->featured_image_url); ?>"
