            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <?php if($member->user->profile_photo): ?>
                                <img src="<?php echo e($member->user->profile_photo_url); ?>"
                            ...
                            <?php else: ?>
                                <div class="bg-light-primary rounded-circle d-flex align-items-center justify-content-center"
                                    ...
                                    <span class="text-primary fw-bold">
                                        <?php echo e(substr($member->user->getDisplayName(), 0, 2)); ?>
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1"><?php echo e($member->user->getDisplayName()); ?></h6>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center mt-1">
                            <?php if($group->creator->profile_photo): ?>
                                <img src="<?php echo e($group->creator->profile_photo_url); ?>"
                            ...
                            <?php else: ?>
                                <div class="bg-light-primary rounded-circle d-flex align-items-center justify-content-center me-2"
                                    ...
                                    <span class="text-primary fw-bold" style="font-size: 12px;">
                                        <?php echo e(substr($group->creator->getDisplayName(), 0, 2)); ?>

                                    </span>
                                </div>
                            <?php endif; ?>
                            <span><?php echo e($group->creator->getDisplayName()); ?></span>
                        </div>
                    </div>
                    <div class="mb-3">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <?php if($group->hasAdmin(auth()->user()) || auth()->user()->hasRole('admin')): ?>
                        <a href="<?php echo e(route('groups.invitations.pending', $group)); ?>" class="btn btn-outline-success btn-sm">
                            <i class="ph-duotone ph-envelope me-2"></i>
                            <?php echo e(__('groups.manage_invitations')); ?>

                        </a>
                        <a href="<?php echo e(route('groups.requests.pending', $group)); ?>" class="btn btn-outline-info btn-sm">
                            <i class="ph-duotone ph-hand-waving me-2"></i>
