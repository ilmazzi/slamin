<?php $__env->startSection('title', 'Conti di Pagamento'); ?>
        ...
        <div class="row m-1">
            <div class="col-12">
                ...
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="">
                        <a href="<?php echo e(route('dashboard')); ?>" class="f-s-14 f-w-500">Profilo</a>
                    </li>
                    <li class="active">
        ...
        <div class="row mb-4">
                ...
                <div class="card hover-effect equal-card">
                    <div class="card-body text-center py-3">
                        <div class="d-flex align-items-center justify-content-center mb-2">
                            <div class="rounded-circle <?php echo e($user->stripe_connect_status === 'active' ? 'bg-light-success' : 'bg-light-warning'); ?> d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                                <i class="ph-duotone ph-credit-card f-s-20 <?php echo e($user->stripe_connect_status === 'active' ? 'text-success' : 'text-warning'); ?>"></i>
                            </div>
                        </div>
                        <h6 class="mb-1 f-s-16">Stripe Connect</h6>
                        <span class="badge <?php echo e($user->stripe_connect_status === 'active' ? 'bg-success' : 'bg-warning'); ?> f-s-12">
                            <?php echo e($user->stripe_connect_status === 'active' ? 'Attivo' : 'In Attesa'); ?>
            ...
            <div class="col-md-4">
                <div class="card hover-effect equal-card">
                    <div class="card-body text-center py-3">
                        <div class="d-flex align-items-center justify-content-center mb-2">
                            <div class="rounded-circle <?php echo e($user->paypal_verified ? 'bg-light-success' : 'bg-light-warning'); ?> d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                                <i class="ph-duotone ph-paypal-logo f-s-20 <?php echo e($user->paypal_verified ? 'text-success' : 'text-warning'); ?>"></i>
                            </div>
                        </div>
                        <h6 class="mb-1 f-s-16">PayPal</h6>
                        <span class="badge <?php echo e($user->paypal_verified ? 'bg-success' : 'bg-warning'); ?> f-s-12">
                            <?php echo e($user->paypal_verified ? 'Verificato' : 'Non Verificato'); ?>
            ...
            <div class="col-md-4">
                <div class="card hover-effect equal-card">
                    <div class="card-body text-center py-3">
                        ...
                        <span class="badge bg-info f-s-12"><?php echo e(ucfirst($user->preferred_payout_method)); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php if($user->stripe_connect_account_id): ?>
                            <div class="mb-3">
                                <h6>Account ID: <code><?php echo e($user->stripe_connect_account_id); ?></code></h6>
                                <p class="text-muted small">Collegato il <?php echo e($user->stripe_connected_at->format('d/m/Y H:i')); ?></p>
                            </div>

                            <?php if($user->stripe_connect_status === 'active'): ?>
                                <div class="alert alert-success">
                                    <i class="ph-duotone ph-check-circle me-2"></i>
                                ...
                                <div class="d-flex gap-2">
                                    <a href="<?php echo e(route('profile.payment-accounts.update-stripe-status')); ?>" class="btn btn-outline-primary">
                                        <i class="ph-duotone ph-arrow-clockwise me-1"></i>Aggiorna Stato
                                    </a>
                                    <form method="POST" action="<?php echo e(route('profile.payment-accounts.disconnect')); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
                            ...
                            <?php elseif($user->stripe_connect_status === 'pending'): ?>
                                ...
                                <div class="d-flex gap-2">
                                        <form method="GET" action="<?php echo e(route('profile.payment-accounts.stripe-onboarding')); ?>" class="d-inline">
                                            <button type="submit" class="btn btn-warning">
                                                <i class="ph-duotone ph-arrow-right me-1"></i>Completa Configurazione
                                            </button>
                                        </form>
                                    <form method="GET" action="<?php echo e(route('profile.payment-accounts.update-stripe-status')); ?>" class="d-inline">
                        ...
                        <?php else: ?>
                            <div class="text-center py-4">
                                ...
                                <p class="text-muted">Ricevi pagamenti automaticamente sul tuo conto bancario</p>
                                    <form method="POST" action="<?php echo e(route('profile.payment-accounts.create-stripe')); ?>" class="d-inline" id="stripe-form">
                                        <?php echo csrf_field(); ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php if($user->paypal_email): ?>
                            <div class="mb-3">
                                <h6>Email: <code><?php echo e($user->paypal_email); ?></code></h6>
                                <p class="text-muted small">Collegato il <?php echo e($user->paypal_connected_at->format('d/m/Y H:i')); ?></p>
                            </div>
                        ...
                        <?php else: ?>
                            <form method="POST" action="<?php echo e(route('profile.payment-accounts.setup-paypal')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
        ...
        <div class="row mt-4">
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('profile.payment-accounts.setup-bank')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Nome Banca</label>
                                    <input type="text" class="form-control" name="bank_name"
                                           value="<?php echo e($user->bank_name); ?>" placeholder="es. Intesa Sanpaolo">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Intestatario Conto</label>
                                    <input type="text" class="form-control" name="bank_account_holder"
                                           value="<?php echo e($user->bank_account_holder); ?>" placeholder="Nome Cognome">
                                </div>
                                <div class="col-md-8 mb-3">
                                    <label class="form-label">IBAN</label>
                                    <input type="text" class="form-control" name="bank_iban"
                                           value="<?php echo e($user->bank_iban); ?>" placeholder="IT60X0542811101000000123456">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">SWIFT/BIC</label>
                                    <input type="text" class="form-control" name="bank_swift"
                                           value="<?php echo e($user->bank_swift); ?>" placeholder="es. BCITITMM">
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary">
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('profile.payment-accounts.set-preferred-method')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                                <label class="form-label">Metodo di Payout Preferito</label>
                                <select class="form-select" name="preferred_payout_method">
                                    <option value="stripe" <?php echo e($user->preferred_payout_method === 'stripe' ? 'selected' : ''); ?>>
                                        Stripe Connect (Automatico)
                                    </option>
                                    <option value="paypal" <?php echo e($user->preferred_payout_method === 'paypal' ? 'selected' : ''); ?>>
                                        PayPal (Manuale)
                                    </option>
                                    <option value="manual" <?php echo e($user->preferred_payout_method === 'manual' ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\slamin\resources\views/profile/payment-accounts.blade.php ENDPATH**/ ?>