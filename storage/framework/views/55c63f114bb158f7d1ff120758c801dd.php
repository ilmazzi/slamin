<?php $__env->startSection('title', __('poems.bookmarks.title')); ?>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0"><?php echo e(__('poems.bookmarks.title')); ?></h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"><?php echo e(__('poems.bookmarks.title')); ?></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="mb-1"><?php echo e($bookmarks->total()); ?></h4>
                            <p class="text-muted mb-0"><?php echo e(__('poems.bookmarks.total_bookmarks')); ?></p>
                        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-light-info">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="mb-1"><?php echo e($bookmarks->where('created_at', '>=', now()->subDays(7))->count()); ?></h4>
                            <p class="text-muted mb-0"><?php echo e(__('poems.bookmarks.recent_bookmarks')); ?></p>
                        </div>
                        <div class="flex-shrink-0">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-light-success">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="mb-1"><?php echo e($bookmarks->unique('user_id')->count()); ?></h4>
                            <p class="text-muted mb-0"><?php echo e(__('poems.bookmarks.authors')); ?></p>
                        </div>
                        <div class="flex-shrink-0">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-light-primary">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="mb-1"><?php echo e($bookmarks->unique('category')->count()); ?></h4>
                            <p class="text-muted mb-0"><?php echo e(__('poems.bookmarks.categories')); ?></p>
                        </div>
                        <div class="flex-shrink-0">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="card-title mb-0">
                                ...
                                <?php echo e(__('poems.bookmarks.your_bookmarks')); ?>

                            </h5>
                            <p class="text-muted mb-0"><?php echo e(__('poems.bookmarks.description')); ?></p>
                        </div>
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-outline-danger" onclick="clearAllBookmarks()">
                                <i class="ph ph-trash me-2"></i>
                                <?php echo e(__('poems.bookmarks.clear_all')); ?>
                            ...
                            <a href="<?php echo e(route('poems.index')); ?>" class="btn btn-outline-primary">
                                ...
                                <?php echo e(__('poems.bookmarks.explore_poems')); ?>
                    ...
                    <form method="GET" class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="<?php echo e(route('poems.bookmarks')); ?>" class="btn btn-outline-secondary">
    ...
    <!-- Lista segnalibri -->
    <div class="row">
        <?php $__empty_1 = true; $__currentLoopData = $bookmarks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $poem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-2">
                            <span class="badge bg-warning">
                                <i class="ph ph-bookmark me-1"></i><?php echo e(__('poems.status.bookmarked')); ?>
                        ...
                        <div class="mb-3">
                            <small class="text-muted">
                                ...
                                <?php echo e(__('poems.bookmarks.bookmarked_on')); ?> <?php echo e($poem->pivot->created_at->format('d/m/Y')); ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group btn-group-sm">
                                ...
                                <button type="button" class="btn btn-outline-warning" onclick="removeBookmark(<?php echo e($poem->id); ?>)">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a class="dropdown-item text-warning" href="#" onclick="removeBookmark(<?php echo e($poem->id); ?>)">
                                            <i class="ph ph-bookmark-simple me-2"></i><?php echo e(__('poems.bookmarks.remove_bookmark')); ?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body text-center py-5">
                        ...
                        <h4 class="text-muted mb-3"><?php echo e(__('poems.bookmarks.no_bookmarks')); ?></h4>
                        <p class="text-muted mb-4"><?php echo e(__('poems.bookmarks.no_bookmarks_description')); ?></p>
                        <div class="d-flex justify-content-center gap-2">
                            ...
                            <a href="<?php echo e(route('poems.liked')); ?>" class="btn btn-outline-primary">
                                <i class="ph ph-heart me-2"></i>
                                <?php echo e(__('poems.bookmarks.view_liked_poems')); ?>
...
function removeBookmark(poemId) {
    if (confirm('<?php echo e(__("poems.bookmarks.remove_confirm")); ?>')) {
        ...
        .then(data => {
            if (data.success) {
                ...
                alert(data.message || '<?php echo e(__("poems.bookmarks.remove_error")); ?>');
            }
        });
    }
}
...
function clearAllBookmarks() {
    if (confirm('<?php echo e(__("poems.bookmarks.clear_all_confirm")); ?>')) {
        ...
        .then(data => {
            if (data.success) {
                ...
                alert(data.message || '<?php echo e(__("poems.bookmarks.clear_all_error")); ?>');
            }
        });
    }
}
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\slamin\resources\views/poems/bookmarks.blade.php ENDPATH**/ ?>