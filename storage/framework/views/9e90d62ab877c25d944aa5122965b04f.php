                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-2">
                                ...
                                Autore: <?php echo e($video->user->name); ?>
...
function incrementVideoViews() {
    console.log('Incrementando visualizzazioni per video <?php echo e($video->id); ?>');

    fetch('<?php echo e(route("videos.increment-views", $video)); ?>', {
        method: 'POST',
        headers: {
...
document.getElementById('commentForm').addEventListener('submit', function(e) {
    ...
    fetch('<?php echo e(route("videos.add-comment", $video)); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
function deleteComment(commentId) {
    ...
    fetch(`<?php echo e(route('videos.delete-comment', '')); ?>/${commentId}`, {
        method: 'DELETE',
        headers: {
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
        }
...
function showSnapModal() {
    ...
    if (videoPlayer && !videoPlayer.paused) {
        videoPlayer.pause();
        console.log('⏸️ <?php echo e(__('common.video')); ?> fermato per creazione snap');
    }
...
function createSnap() {
    ...
    .then(data => {
        if (data.success) {
            console.log('✅ <?php echo e(__('common.snap')); ?> creato con successo:', data.snap);
...
function deleteSnap(snapId) {
    ...
    fetch(`<?php echo e(route('videos.delete-snap', '')); ?>/${snapId}`, {
        method: 'DELETE',
        headers: {
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
        }
...
setInterval(function() {
    if (isVideoPlaying) {
        console.log('📊 <?php echo e(__('invitations.status')); ?> video - isVideoPlaying:', isVideoPlaying, 'currentVideoTime:', currentVideoTime, 'videoDuration:', videoDuration);
    }
}, 30000);
});
...
async function initializeVideoPlayer() {
    ...
    try {
        ...
        if (data.status === 'processing') {
            console.log('⏳ <?php echo e(__('common.video')); ?> ancora in elaborazione su PeerTube');
...
function setupVideoEventListeners() {
    ...
    videoPlayer.addEventListener('loadedmetadata', function() {
        console.log('🎬 <?php echo e(__('common.video')); ?> caricato - Durata:', videoPlayer.duration);
    ...
    videoPlayer.addEventListener('canplay', function() {
        console.log('▶️ <?php echo e(__('common.video')); ?> pronto per la riproduzione');
    });
    ...
    videoPlayer.addEventListener('canplaythrough', function() {
        console.log('🎯 <?php echo e(__('common.video')); ?> può essere riprodotto completamente');
    });

    // Event listener per play
    videoPlayer.addEventListener('play', function() {
        console.log('▶️ <?php echo e(__('common.video')); ?> in riproduzione');
        isVideoPlaying = true;
        incrementVideoViews();
    });
    ...
    videoPlayer.addEventListener('pause', function() {
        console.log('⏸️ <?php echo e(__('common.video')); ?> in pausa');
    ...
    videoPlayer.addEventListener('ended', function() {
        console.log('🏁 <?php echo e(__('common.video')); ?> terminato');
        isVideoPlaying = false;
    ...
    videoPlayer.addEventListener('stalled', function() {
        console.log('⚠️ <?php echo e(__('common.video')); ?> in stallo - potrebbe non essere accessibile');
    });

    // Event listener per quando il video non ha dati
    videoPlayer.addEventListener('waiting', function() {
        console.log('⏳ <?php echo e(__('common.video')); ?> in attesa di dati');
    });
