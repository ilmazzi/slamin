                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <div class="d-flex align-items-center gap-2 mb-1">
                                                                    <span class="badge bg-primary">
                                                                        <?php if($festivalEvent->start_datetime): ?>
                                                                            <?php echo e($festivalEvent->start_datetime->format('d/m/Y')); ?>
                                        ...
                                        <div class="card-body p-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        <span class="badge bg-primary">
                                                            <?php if($festival->start_datetime): ?>
                                                                <?php echo e($festival->start_datetime->format('d/m/Y')); ?>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <?php if($event->organizer_id === auth()->id() || auth()->user()->hasAnyRole(['admin', 'moderator'])): ?>
                                ...
                                <?php if($event->organizer_id === auth()->id()): ?>
                                    ...
                                    <?php if($event->is_availability_based): ?>
                                        <a href="<?php echo e(route('events.availability.show', $event)); ?>" class="btn btn-light-info w-100 mb-2">
                                            <i class="ph ph-calendar-check me-2"></i><?php echo e(__('events.availability_options')); ?>
                            ...
                            <?php elseif($hasInvitation): ?>
                                ...
                                <?php elseif($userInvitation->status === 'accepted'): ?>
                                    ...
                                    <?php if($event->isAvailabilityBased() && $event->activeAvailabilityOptions->count() > 0): ?>
                                        <a href="<?php echo e(route('events.availability.respond', $event)); ?>" class="btn btn-warning w-100 mb-2">
                                            <i class="ph ph-calendar-check me-2"></i>Rispondi alle Disponibilità
                                        </a>
                                    <?php endif; ?>
                            ...
                            <?php elseif($canApply): ?>
                                ...
                                <?php if($event->is_availability_based): ?>
                                    <a href="<?php echo e(route('events.availability.respond', $event)); ?>" class="btn btn-light-info w-100 mb-2">
                                        <i class="ph ph-calendar-check me-2"></i><?php echo e(__('events.respond_to_availability')); ?>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="border-start border-4 ps-3 mb-3" style="border-color: rgb(15, 98, 106) !important;">
                        ...
                        <?php elseif($event->is_availability_based): ?>
                            <p class="mb-0"><?php echo e(__('events.availability_based_event')); ?></p>
                            <small class="text-muted"><?php echo e(__('events.availability_based_event_description')); ?></small>
                        <?php else: ?>
                            <p class="mb-0"><?php echo e(__('events.not_specified')); ?></p>
                        <?php endif; ?>
                    </div>
