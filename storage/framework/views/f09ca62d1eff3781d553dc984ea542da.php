                ...
                <div class="card-body p-0">
                    <div id="eventsMap" style="height: 300px; border-radius: 10px; overflow: hidden; position: relative;">
                        <div class="map-controls position-absolute top-0 end-0 p-2" style="z-index: 1000;">
                            <button class="btn btn-light btn-sm mb-1 d-block" onclick="centerOnUser()" title="<?php echo e(__('events.center_on_my_position')); ?>">
                                <i class="ph ph-crosshairs f-s-14"></i>
                            </button>
                            <button class="btn btn-light btn-sm mb-1 d-block" onclick="refreshEvents()" title="<?php echo e(__('events.refresh_events')); ?>">
                                <i class="ph ph-arrow-clockwise f-s-14"></i>
                            </button>
                            <button class="btn btn-light btn-sm d-block" onclick="showAllEvents()" title="<?php echo e(__('events.show_all_events')); ?>">
                            ...
                            <div class="col-lg-9 col-md-12">
                                <div class="d-flex flex-wrap gap-2 align-items-center p-2">
                                    ...
                                    <button type="button" class="btn btn-outline-danger btn-sm" data-filter="past">
                                        <i class="ph ph-clock-counter-clockwise me-1"></i> <?php echo e(__('events.past_events')); ?>
        ...
        <div class="col-12">
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center mb-3 gap-2">
                ...
                <div class="d-flex align-items-center gap-2">
                    <label class="form-label mb-0 f-s-14"><?php echo e(__('events.show')); ?>:</label>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $events->take(request('per_page', 10)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-12 col-sm-6 col-lg-4 mb-4">
                <div class="card h-100 position-relative">
                    <!-- Past Event Ribbon -->
                    <?php if($event->start_datetime && $event->start_datetime < now()): ?>
                        <div class="arrow-ribbon arrow-left ribbon-danger" style="z-index: 5000;">
                            <span><?php echo e(__('events.past_event')); ?></span>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="position-absolute top-0 end-0 p-2" style="z-index: 3;">
                        <div class="d-flex flex-column gap-1">
                            <?php if($event->is_public): ?>
                                <span class="badge bg-success f-s-10"><?php echo e(__('events.public')); ?></span>
                            <?php else: ?>
                                <span class="badge bg-warning f-s-10"><?php echo e(__('events.private')); ?></span>
                            <?php endif; ?>
                            ...
                            <?php if($event->category): ?>
                                <span class="badge <?php echo e($event->category_color_class); ?> f-s-10">
                    ...
                    <div class="position-relative overflow-hidden" style="height: 200px;">
                        ...
                        <div class="position-absolute bottom-0 start-0 text-white p-2 w-100" style="z-index: 2;">
                            <?php if($event->is_online): ?>
                                <h6 class="mb-1 text-white f-s-12"><?php echo e(__('events.online_event')); ?></h6>
                                <small class="text-white-50 f-s-10"><i class="ph ph-globe me-1"></i><?php echo e(__('events.virtual_event')); ?></small>
                            <?php else: ?>
                            <h6 class="mb-1 text-white f-s-12"><?php echo e(Str::limit($event->venue_name, 30)); ?></h6>
                            <small class="text-white-50 f-s-10"><i class="ph ph-map-pin me-1"></i><?php echo e($event->city); ?></small>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="card-body d-flex flex-column p-3">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div class="flex-grow-1 me-2">
                                ...
                                <?php if($event->subtitle): ?>
                                    <h6 class="text-muted mb-2 f-s-12"><?php echo e(Str::limit($event->subtitle, 40)); ?></h6>
                                <?php endif; ?>
                            ...
                            <div class="flex-shrink-0">
                                <div class="bg-light-primary text-center d-flex flex-column align-items-center justify-content-center" style="min-width: 45px; min-height: 45px; font-size: 11px; border-radius: 6px;">
                                    <div class="fw-bold f-s-12"><?php echo e($event->start_datetime ? $event->start_datetime->format('d') : '--'); ?></div>
                                    <div class="f-s-10"><?php echo e($event->start_datetime ? $event->start_datetime->format('M') : '--'); ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="d-flex align-items-center text-muted mb-1">
                                ...
                                <span class="f-s-12"><?php echo e($event->start_datetime ? $event->start_datetime->format('H:i') : '--:--'); ?> - <?php echo e($event->end_datetime ? $event->end_datetime->format('H:i') : '--:--'); ?></span>
                            </div>
                            <div class="d-flex align-items-center text-muted mb-1">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.social-view-counter','data' => ['content' => $event,'type' => 'event']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.social-comment-button','data' => ['content' => $event,'type' => 'event']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                ...
                                <div class="d-flex gap-1">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('events.manage.own')): ?>
                                        <?php if(Auth::user()->hasRole(['admin', 'moderator']) || ($event->organizer_id === Auth::id() && $event->start_datetime && $event->start_datetime >= now())): ?>
                                            <button type="button" class="btn btn-light btn-sm"
                                                    onclick="confirmDeleteEvent(<?php echo e($event->id); ?>, '<?php echo e(addslashes($event->title)); ?>')"
                                                    title="<?php echo e(__('events.delete_event')); ?>">
        ...
        <div class="col-6 col-md-3 mb-3">
            <div class="card hover-effect equal-card">
                <div class="card-body text-center py-3">
                    ...
                    <h5 class="mb-1 f-s-16"><?php echo e($statistics['total_events']); ?></h5>
                    <p class="text-muted mb-0 f-s-12"><?php echo e(__('events.total_events')); ?></p>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3 mb-3">
            <div class="card hover-effect equal-card">
                <div class="card-body text-center py-3">
                    ...
                    <h5 class="mb-1 f-s-16"><?php echo e($statistics['public_events']); ?></h5>
                    <p class="text-muted mb-0 f-s-12"><?php echo e(__('events.public_events_count')); ?></p>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3 mb-3">
            <div class="card hover-effect equal-card">
                <div class="card-body text-center py-3">
                    ...
                    <h5 class="mb-1 f-s-16"><?php echo e($statistics['upcoming_events']); ?></h5>
                    <p class="text-muted mb-0 f-s-12"><?php echo e(__('events.upcoming_events_count')); ?></p>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3 mb-3">
            <div class="card hover-effect equal-card">
                <div class="card-body text-center py-3">
                    ...
                    <h5 class="mb-1 f-s-16"><?php echo e($statistics['venues_count']); ?></h5>
                    <p class="text-muted mb-0 f-s-12"><?php echo e(__('events.venues_count')); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                    <h5 class="modal-title" id="eventDetailsModalLabel"><?php echo e(__('events.event_details')); ?></h5>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo e(__('events.close')); ?></button>
                    <a href="#" class="btn btn-primary" id="eventDetailsModalLink"><?php echo e(__('events.view_complete_details')); ?></a>
                </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-danger" id="deleteEventModalLabel">
                    <i class="ph ph-warning me-2"></i><?php echo e(__('events.delete_event_title')); ?>

                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo e(__('common.close')); ?>"></button>
            </div>
            <div class="modal-body">
                <p><?php echo e(__('events.confirm_delete_event', ['title' => '<strong id="deleteEventTitle"></strong>'])); ?></p>
                <div class="alert alert-warning">
                    <i class="ph ph-warning me-2"></i>
                    <strong><?php echo e(__('events.warning')); ?></strong> <?php echo e(__('events.delete_action_warning')); ?>

                    <ul class="mb-0 mt-2">
                        <li><?php echo e(__('events.delete_warning_participants')); ?></li>
                        <li><?php echo e(__('events.delete_warning_invitations')); ?></li>
                        <li><?php echo e(__('events.delete_warning_favorites')); ?></li>
                        <li><?php echo e(__('events.delete_warning_festival')); ?></li>
                    </ul>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo e(__('events.cancel')); ?></button>
                <form id="deleteEventForm" method="POST" class="d-inline">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('DELETE'); ?>
                    <button type="submit" class="btn btn-danger">
                        <i class="ph ph-trash me-2"></i><?php echo e(__('events.delete_permanently')); ?>
...
function loadEventsOnMapWithFilter(params) {
    ...
    .then(events => {
            ...
            if (events.length === 0) {
                ...
                showNotification('<?php echo e(__('events.no_events_with_filters')); ?>', 'info');
                return;
            }
    ...
    .catch(error => {
            ...
            showNotification('<?php echo e(__('events.error_loading_events')); ?>', 'error');
    });
}
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(
            function(position) {
                ...
                showNotification('<?php echo e(__('events.map_centered_on_position')); ?>', 'success');
            },
            function(error) {
                let message = error.code === 1 ?
                    '<?php echo e(__('events.geolocation_https_required')); ?>' :
                    '<?php echo e(__('events.cannot_get_position')); ?>';
...
function refreshEvents() {
    ...
    showNotification('<?php echo e(__('events.events_updated')); ?>', 'success');
}
            ...
            if (data.success && data.events) {
                ...
                data.events.forEach(event => {
                    if (event.latitude && event.longitude) {
                        L.marker([parseFloat(event.latitude), parseFloat(event.longitude)])
                            ...
                            .bindPopup(`
                                <div class="p-2">
                                    <h6>${event.title}</h6>
                                    ${event.is_online ?
                                        `<p class="mb-2"><i class="ph ph-globe me-1"></i><?php echo e(__('events.online_event_label')); ?></p>` :
                        ...
                        showNotification('<?php echo e(__('events.events_shown', ['count' => ''])); ?>'.replace(':count', data.events.length), 'success');
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    ...
                    <span class="badge ${event.category_color_class} fs-6">${event.category_name || '<?php echo e(__('events.not_available')); ?>'}</span>
                </div>
        ...
        modalContent += `
                <div class="row mb-3">
                    <div class="col-12">
                        ...
                        <strong class="text-success"><?php echo e(__('events.online_event_label')); ?></strong>
        ...
        modalContent += `
                <div class="row mb-3">
                    <div class="col-12">
                        ...
                        <strong><?php echo e(__('events.location_label')); ?></strong> ${event.venue_name || '<?php echo e(__('events.not_available')); ?>'}
    ...
    modalContent += `
                <div class="row mb-3">
                    <div class="col-12">
                        ...
                        <strong><?php echo e(__('events.organizer_label')); ?></strong> ${event.organizer}
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <strong><?php echo e(__('events.participants_label')); ?></strong> ${event.max_participants || '<?php echo e(__('events.unlimited')); ?>'}
                    </div>
                    <div class="col-6">
                        <i class="fas fa-euro-sign text-success me-2"></i>
                        <strong><?php echo e(__('events.price_label')); ?></strong> ${event.entry_fee ? event.entry_fee + '€' : '<?php echo e(__('events.free_label')); ?>'}
                    </div>
                </div>
            </div>
        </div>
