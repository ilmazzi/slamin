                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="d-flex flex-wrap gap-2 justify-content-center justify-content-lg-end">
                                ...
                                <label class="btn btn-outline-secondary btn-sm" for="timeframe_1m"><?php echo e(__('user_stats.1_month')); ?></label>

                                <input type="radio" class="btn-check" name="timeframe" id="timeframe_3m" value="3_months"
                                       <?php echo e($timeframe === '3_months' ? 'checked' : ''); ?>>
                                <label class="btn btn-outline-secondary btn-sm" for="timeframe_3m"><?php echo e(__('user_stats.3_months')); ?></label>

                                <input type="radio" class="btn-check" name="timeframe" id="timeframe_12m" value="12_months"
                                       <?php echo e($timeframe === '12_months' ? 'checked' : ''); ?>>
                                <label class="btn btn-outline-secondary btn-sm" for="timeframe_12m"><?php echo e(__('user_stats.12_months')); ?></label>

                                <input type="radio" class="btn-check" name="timeframe" id="timeframe_all" value="all_time"
                                       <?php echo e($timeframe === 'all_time' ? 'checked' : ''); ?>>
                                <label class="btn btn-outline-secondary btn-sm" for="timeframe_all"><?php echo e(__('user_stats.all_time')); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
