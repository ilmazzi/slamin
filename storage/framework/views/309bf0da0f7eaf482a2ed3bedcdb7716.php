<?php $__env->startSection('title', 'Chat - Poetry Slam'); ?>
                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <span class="chatdp h-45 w-45 d-flex-center b-r-50 position-relative bg-primary">
                            <img src="<?php echo e(auth()->user()->profile_photo_url); ?>" alt="" class="img-fluid b-r-50">
                            <span class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                        </span>
                        <div class="flex-grow-1 ps-2">
                            <div class="fs-6"><?php echo e(auth()->user()->name); ?></div>
                            <div class="text-muted f-s-12"><?php echo e(auth()->user()->getRoleDisplayNameAttribute()); ?></div>
                        </div>
                        <div>
...
function setupEventListeners() {
    ...
    window.Echo.private('App.Models.User.' + <?php echo e(auth()->id()); ?>).listen('user-typing', (e) => {
