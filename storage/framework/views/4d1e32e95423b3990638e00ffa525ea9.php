                                    ...
                                    <div class="person-details">
                                        ...
                                        <div class="details">
                                            <div>
                                                ...
                                                <p class="text-secondary"><?php echo e(__('profile.organized_events')); ?></p>
                                            </div>
                                            <div>
                                                <h4 class="text-success"><?php echo e($stats['participated_events']); ?></h4>
                                                <p class="text-secondary"><?php echo e(__('profile.participated_events')); ?></p>
                                            </div>
                                            <div>
                                                <h4 class="text-warning"><?php echo e($stats['total_videos']); ?></h4>
                                                <p class="text-secondary"><?php echo e(__('profile.uploaded_videos')); ?></p>
                                            </div>
                                        </div>
