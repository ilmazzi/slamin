                ...
                <div class="card-body p-0">
                    ...
                    <img src="<?php echo e(\App\Helpers\AvatarHelper::getUserAvatarUrl($user)); ?>"
                        ...
                        <div class="person-details">
                            ...
                            <?php else: ?>
                            <p><?php echo e(__('profile.member_since')); ?> <?php echo e($user->created_at ? $user->created_at->format('M Y') : 'N/A'); ?></p>
                            <?php endif; ?>
                ...
                <div class="card-body">
                    ...
                    <div class="about-list">
                        ...
                        <div>
                            ...
                            <span class="float-end f-s-13 text-secondary"><?php echo e(\App\Helpers\PrivacyHelper::hidePhone($user->phone)); ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div>
                            ...
                            <span class="float-end f-s-13 text-secondary"><?php echo e($user->created_at ? $user->created_at->format('M Y') : 'N/A'); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="tab-wrapper">
                        <ul class="profile-app-tabs">
                            ...
                            <li class="tab-link fw-medium f-s-16 f-w-600" data-tab="2">
                                <i class="ph ph-book-open fw-bold"></i> <?php echo e(__('profile.poems')); ?>

                                <?php if($stats['total_poems'] > 0): ?>
                                <span class="badge rounded-pill bg-success badge-notification">
                                    <?php echo e($stats['total_poems']); ?>
                            ...
                            <li class="tab-link fw-medium f-s-16 f-w-600" data-tab="4">
                                ...
                                <?php if(($user->photos()->approved()->count() + $videos->count()) > 0): ?>
                                <span class="badge rounded-pill bg-info badge-notification">
                                    <?php echo e($user->photos()->approved()->count() + $videos->count()); ?>
                            ...
                            <li class="tab-link fw-medium f-s-16 f-w-600" data-tab="6">
                                ...
                                <span class="badge rounded-pill bg-secondary badge-notification">
                            ...
                            <?php if($isOwnProfile): ?>
                            <li class="tab-link fw-medium f-s-16 f-w-600" data-tab="7">
            ...
            <div class="content-wrapper">
                ...
                <div id="tab-2" class="tabs-content">
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="mb-0"><?php echo e(__('profile.poems')); ?></h5>
                                <?php if($isOwnProfile): ?>
                                <a href="<?php echo e(route('poems.create')); ?>" class="btn btn-sm btn-primary hover-effect">
                                    <i class="ti ti-plus"></i> <?php echo e(__('profile.add_poem')); ?>
                        ...
                        <div class="card-body">
                            <?php if($stats['total_poems'] > 0): ?>
                            <div class="row">
                                <?php $__currentLoopData = $user->poems()->latest()->take(6)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $poem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-6 col-lg-4 mb-3">
                                    <div class="card hover-effect">
                                        <div class="card-body">
                                            <h6 class="card-title fw-semibold"><?php echo e(Str::limit($poem->title, 30)); ?></h6>
                                            <p class="card-text text-muted f-s-13"><?php echo e(Str::limit($poem->content, 100)); ?></p>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <small class="text-muted"><?php echo e($poem->created_at ? $poem->created_at->format('d/m/Y') : 'N/A'); ?></small>
                                                <a href="<?php echo e(route('poems.show', $poem->slug ?: $poem->id)); ?>" class="btn btn-sm btn-outline-primary">
                            ...
                            <?php if($stats['total_poems'] > 6): ?>
                            <div class="text-center mt-3">
                                <a href="<?php echo e(route('poems.index', ['user' => $user->id])); ?>" class="btn btn-primary">
                                    <?php echo e(__('profile.view_all_poems')); ?>
                            ...
                            <div class="text-center py-5">
                                ...
                                <h5 class="mt-3 text-muted"><?php echo e(__('profile.no_poems')); ?></h5>
                                <?php if($isOwnProfile): ?>
                                <p class="text-muted"><?php echo e(__('profile.no_poems_description')); ?></p>
                                <a href="<?php echo e(route('poems.create')); ?>" class="btn btn-primary">
                                    <i class="ti ti-plus"></i> <?php echo e(__('profile.create_first_poem')); ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="mb-0"><?php echo e(__('profile.organized_events_title')); ?></h5>
                                <?php if($isOwnProfile): ?>
                                <a href="<?php echo e(route('events.create')); ?>" class="btn btn-sm btn-primary hover-effect">
                                    <i class="ti ti-plus"></i> <?php echo e(__('profile.create_event')); ?>
                        ...
                        <div class="card-body">
                            <?php if($stats['total_events'] > 0): ?>
                            <div class="row">
                                <?php $__currentLoopData = $user->events()->latest()->take(6)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-6 col-lg-4 mb-3">
                                    <div class="card hover-effect">
                                        <div class="card-body">
                                            <h6 class="card-title fw-semibold"><?php echo e(Str::limit($event->title, 30)); ?></h6>
                                            <p class="card-text text-muted f-s-13">
                                                <i class="ti ti-calendar"></i> <?php echo e($event->date ? $event->date->format('d/m/Y') : __('events.date_not_set')); ?><br>
                                                <i class="ti ti-map-pin"></i> <?php echo e(Str::limit($event->venue_name, 25)); ?>

                                            </p>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <span class="badge bg-primary"><?php echo e($event->status); ?></span>
                            ...
                            <?php if($stats['total_events'] > 6): ?>
                            <div class="text-center mt-3">
                                <a href="<?php echo e(route('events.index', ['organizer' => $user->id])); ?>" class="btn btn-primary">
                                    <?php echo e(__('profile.view_all_events')); ?>
                            ...
                            <div class="text-center py-5">
                                ...
                                <h5 class="mt-3 text-muted"><?php echo e(__('profile.no_events')); ?></h5>
                                <?php if($isOwnProfile): ?>
                                <p class="text-muted"><?php echo e(__('profile.no_events_description')); ?></p>
                                <a href="<?php echo e(route('events.create')); ?>" class="btn btn-primary">
                                    <i class="ti ti-plus"></i> <?php echo e(__('profile.create_first_event')); ?>
