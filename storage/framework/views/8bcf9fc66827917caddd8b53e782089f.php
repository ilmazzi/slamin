                                ...
                                <div class="col-md-3 col-6 mb-3">
                                    <div class="card equal-card">
                                        <div class="card-body text-center py-3">
                                            ...
                                            <h4 class="mb-1 text-primary f-s-18"><?php echo e(number_format($stats['total_videos'])); ?></h4>
                                            <p class="text-muted mb-0 f-s-12"><?php echo e(__('home.stats.total_videos')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 col-6 mb-3">
                                        ...
                                        <div class="card-body text-center py-3">
                                            <div class="d-flex align-items-center justify-content-center mb-2">
                                                <div class="rounded-circle bg-light-success d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                                                    <i class="ph-duotone ph-eye f-s-20 text-success"></i>
                                                </div>
                                            </div>
                                            <h4 class="mb-1 text-success f-s-18"><?php echo e(number_format($stats['total_views'])); ?></h4>
                                            <p class="text-muted mb-0 f-s-12"><?php echo e(__('home.stats.total_views')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 col-6 mb-3">
                                        ...
                                        <div class="card-body text-center py-3">
                                            <div class="d-flex align-items-center justify-content-center mb-2">
                                                <div class="rounded-circle bg-light-warning d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                                                    <i class="ph-duotone ph-calendar f-s-20 text-warning"></i>
                                                </div>
                                            </div>
                                            <h4 class="mb-1 text-warning f-s-18"><?php echo e(number_format($stats['total_events'])); ?></h4>
                                            <p class="text-muted mb-0 f-s-12"><?php echo e(__('home.stats.total_events')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 col-6 mb-3">
                                    <div class="card equal-card">
                                        <div class="card-body text-center py-3">
                                            ...
                                            <h4 class="mb-1 text-info f-s-18"><?php echo e(number_format($stats['total_users'])); ?></h4>
                                            <p class="text-muted mb-0 f-s-12"><?php echo e(__('home.stats.total_users')); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <?php if($article->category): ?>
                                                                <span class="badge bg-light-info f-s-10 mb-2">
                                                                    <?php if(is_array($article->category) || is_object($article->category)): ?>
                                                                        <?php echo e($article->category->name ?? 'Categoria'); ?>
