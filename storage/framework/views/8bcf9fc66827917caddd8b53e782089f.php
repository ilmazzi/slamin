                                ...
                                <div class="card-body">
                                    <div class="profile-container"
                                        ...
                                        <div class="person-details">
                                            ...
                                            <p><?php echo e($user->city ?? __('home.location_not_specified')); ?></p>
                                            <div class="details">
                                                <div>
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-secondary"><?php echo e(__('home.follower')); ?></p>
                                                </div>
                                                <div>
                                                    <h4 class="text-primary"><?php echo e($user->following_count ?? 0); ?></h4>
                                                    <p class="text-secondary"><?php echo e(__('home.following')); ?></p>
                                                </div>
                                            </div>
                                            <div class="my-2">
                                                <?php if(auth()->guard()->check()): ?>
