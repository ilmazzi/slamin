...
<?php $__env->startSection('title', 'Nuovo annuncio - ' . $group->name); ?>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="page-description">
                            Crea un nuovo annuncio per <?php echo e($group->name); ?>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo e(route('groups.announcements.store', $group)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            name="visibility" 
                                            required>
                                        <option value="members_only" <?php echo e(old('visibility', 'members_only') === 'members_only' ? 'selected' : ''); ?>>
                                        ...
                                        <?php if($group->hasModerator(auth()->user())): ?>
                                            <option value="admins_only" <?php echo e(old('visibility') === 'admins_only' ? 'selected' : ''); ?>>
                                                Solo amministratori
                                            </option>
                                        <?php endif; ?>
                                    </select>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               name="has_poll" 
                                               value="1" 
                                               <?php echo e(old('has_poll') ? 'checked' : ''); ?>
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\slamin\resources\views/groups/announcements/create.blade.php ENDPATH**/ ?>