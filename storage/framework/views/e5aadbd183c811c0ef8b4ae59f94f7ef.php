        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-4 mb-4">
                <div class="card hover-effect h-100">
                    ...
                    <?php else: ?>
                        <?php echo PlaceholderHelper::getPoemPlaceholderHtml(0, 200, 'card-img-top', route('poems.show', $poem->slug)); ?>

                    <?php endif; ?>
                    <div class="card-body d-flex flex-column">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <h5 class="card-title f-w-600 mb-0 flex-grow-1">
                                <?php if($poem->id && $poem->slug): ?>
                                    <a href="<?php echo e(route('poems.show', $poem->slug)); ?>" class="text-decoration-none">
                                        <?php echo e($poem->title ?: __('poems.untitled')); ?>

                                    </a>
                                <?php else: ?>
                                    <span class="text-muted"><?php echo e($poem->title ?: __('poems.untitled')); ?></span>
                                <?php endif; ?>
                            </h5>
                            ...
                            <div class="d-flex flex-column align-items-center gap-2">
                                <div class="d-flex gap-3 justify-content-center mb-2">
                                    <span class="text-muted f-s-14">
                                        ...
                                        <?php echo e($poem->views_count); ?>

                                    </span>
                                    <span class="text-muted f-s-14">
                                        <i class="ph-duotone ph-heart f-s-12 me-1"></i>
                                        <?php echo e($poem->likes_count); ?>

                                    </span>
                                    <span class="text-muted f-s-14">
                                        <i class="ph-duotone ph-chat-circle f-s-12 me-1"></i>
                                        <?php echo e($poem->comments_count); ?>

                                    </span>
                                </div>
                                <div class="d-flex gap-2 justify-content-center align-items-center">
                                    <?php if($poem->id && $poem->slug): ?>
                                        <a href="<?php echo e(route('poems.show', $poem->slug)); ?>" class="btn btn-primary px-4">
